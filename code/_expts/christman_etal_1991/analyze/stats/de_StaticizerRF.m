 function [stats] = de_StaticizerRF(mSets, mss, stats)
%

  % Get the basic stats for before-rejections
  [stats.raw]    = []; %de_DoStat([], stats.raw, 'basics', mSets.stats, 'de_StatsBasicsRF', mSets, mss);
...
%  [stats.raw.r, mss] = de_DoRejectionsHL(mss, mSets.rej.type, mSets.rej.width);
  ...
  [stats.rej]    = de_DoStat([], stats.rej, 'basics', mSets.stats, 'de_StatsBasicsRF', mSets, mss, ismember(1,mSets.debug));
