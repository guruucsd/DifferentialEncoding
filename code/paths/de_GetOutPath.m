  ...
  switch (dirType)
    ...
    case {'ac_p_base'}
          ...
          origString = [ origString ... % add on AC model settings
                         sprintf('TT=%d', model.ac.retrain_on_task_images), ...
                         sprintf('NI=%f', model.ac.noise_input), ...
                         ...
                         sprintf('TL=%f', model.ac.tol), ...  %   stamp them here too.
                         sprintf('LB=%f', model.ac.lambda), ...
                         sprintf('DO=%f', model.ac.dropout), ...
                         sprintf('TS=%d', model.ac.ts), ...
                         sprintf('WL=[ %f %f ]', model.ac.wlim(1), model.ac.wlim(2)) ...
                        ];
