  ...
  %             m(:,2) = column indices
    ...
    elseif (sH == floor(prod(sI)/2)), mu = zeros(sI); mu(1:2:end) = 1;
    elseif (sH == floor(prod(sI)/3)), mu = zeros(sI); mu(1:3:end) = 1;
    elseif (sH == floor(prod(sI)/4)), mu = zeros(sI); mu(1:4:end) = 1;
    elseif (sH == floor(prod(sI)/5)), mu = zeros(sI); mu(1:5:end) = 1;
