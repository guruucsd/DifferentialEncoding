...
% h             : array of handles to plots
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  function de_PlotConnectivity_1D(C, mu, nInput, nHidden, t)
  % 1d plot
  ...
  % 1d plot
    fig = guru_newFig('connect-inst', 'hu', model.nHidden, model.nInput);
  ...
  % 1d plot
    fig = guru_newFig('connect-avg', 'hu', models(1).nHidden, models(1).nInput);
