...
[args,opts]  = uber_sergent_args('plots',plts,'stats',stats,'runs',25,'distn',{'ipd'}, 'mu', [1.5 2], 'sigma', [5 5], 'nConns', 6, 'nHidden', 850, 'hpl', 1, 'ac.AvgError', 0, 'ac.MaxIterations', 30,'ac.rej.type','sample_std-normd','ac.rej.width',[2]);
