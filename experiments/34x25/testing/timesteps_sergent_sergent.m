...
% Run with ts=5
[trn5, tst5]  = de_SimulatorUber('vanhateren/250', 'sergent_1982/de/sergent', opts, {args{:}, 'ac.ts', 5});

% Run with ts=1
[args1,opts1] = uber_sergent_args('plots', plts,'stats', stats,'runs',2,'ac.ts', 1);
[trn1, tst1]  = de_SimulatorUber('vanhateren/250', 'sergent_1982/de/sergent', opts, {args{:}, 'ac.ts', 1});
