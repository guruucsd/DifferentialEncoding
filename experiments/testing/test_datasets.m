...
% de_MakeDataset('slotnick_etal_2001', 'blob-dot', 'categorical', {'medium', 'bandpass', [11.5, 12]}, true, true);
% de_MakeDataset('slotnick_etal_2001', 'blob-dot', 'coordinate', {'medium'}, true, true);
 de_MakeDataset('slotnick_etal_2001', 'paired-squares', 'coordinate', {'small'}, true, true); %, 'bandpass', [5.5, 6]}, true, true);
...
% de_MakeDataset('slotnick_etal_2001', 'plus-minus', 'coordinate', {'small', 'bandpass', [5.5, 6]}, true, true);
