function [cargs, opts] = common_args(varargin)
  ...
  cargs = {  'parallel', false, 'debug', 1:10, 'ac.debug', 1:10, 'p.debug', 1:10, ...
             ...
             'distn',   {'norme2'},    'mu',         0,    'sigma',       [ 4 10 ], ...
             'nHidden', 102*8,        'hpl',         8,    'nConns',      12, ...
             ...% Input
             'ac.zscore', 0.05, ...
             ...
             'ac.AvgError', 9E-4,         'ac.MaxIterations', 60, ...
             'ac.dropout', 0.5, ...
             'ac.TrainMode','batch',      'ac.Pow', 1, ... %gradient power (usually 1)
             'ac.EtaInit',  2.22E-1,         'ac.Acc', 1.05, 'ac.Dec', 1.5, ... %5E-7 tanh#2, bias=1 resilient
             ...
