...
%% Figure 1 
[~, set_orig] = de_MakeDataset('sergent_1982', 'de', 'sergent', {}, false);
[~, set_img2pol] = de_MakeDataset('sergent_1982', 'de', 'sergent', {'img2pol', 'location', 'LVF'}, false);
[~, set_blurred] = de_MakeDataset('sergent_1982', 'de', 'sergent', {'img2pol', 'location', 'LVF', 'blurring', 8}, false);
...
for ki=1:nkernels
    [~, dset] = de_MakeDataset('sergent_1982', 'de', 'sergent', {'lowpass', kernels(ki), 'small'}, false);%'blurring', kernels(ki), 'small'}, false);
