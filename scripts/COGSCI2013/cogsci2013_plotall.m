...
for fi=cogsci2013_figures(fullfile(cogsci_dir, 'nonoise_10'), fullfile(cogsci_dir, 'noise_10_1'), [0.3 0.4 0.5 0.6 0.7 0.8], cache_file)
    figure(fi);
...
for fi=cogsci2013_figures(fullfile(cogsci_dir, 'nonoise_2'), fullfile(cogsci_dir, 'noise_2_1'), [0.4 0.8], cache_file)
    figure(fi);
...
% % wrongly classified
for fi=cogsci2013_figures(fullfile(cogsci_dir, 'nonoise_2'), fullfile(cogsci_dir, 'nonoise_10'), [0.4 0.8], cache_file)
    figure(fi);
    [~,~,oh] = legend();
...
% % wrongly classified
for fi=cogsci2013_figures(fullfile(cogsci_dir, 'noise_2_1'), fullfile(cogsci_dir, 'noise_10_1'), [0.4 0.8], cache_file)
    figure(fi);
